...
colnames(testData)[2] <- "mosLastDo"
colnames(testData)[3] <- "numDonations"
colnames(testData)[4] <- "totVolDonated"
colnames(testData)[5] <- "mosFirstDo"

# Rename variables in trainingData
colnames(trainingData)[1] <- "ID"
colnames(trainingData)[2] <- "mosLastDo"
colnames(trainingData)[3] <- "numDonations"
colnames(trainingData)[4] <- "totVol"
colnames(trainingData)[5] <- "mosFirstDo"
