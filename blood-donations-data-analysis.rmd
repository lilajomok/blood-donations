...
newDF <- with(TD2, data.frame(ID = ID, mosLastDo = mean(mosLastDo), numDonations = mean(numDonations), totVol = mean(totVol), mosFirstDo = mean(mosFirstDo), donFreq = mean(donFreq), firstTime = factor(firstTime)))
head(newDF)
